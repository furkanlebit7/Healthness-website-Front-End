...
?>
      ...
      <main>
        <h3 class="foods-page-h3">
          FOODS <span>/</span> <a href="./dieticians.php">DIETICIANS</a>
        </h3>
        <section class="food-cards container">

<?php
    $Sorgu=mysqli_query($db,"SELECT * FROM foods");
      while($foods=mysqli_fetch_assoc($Sorgu)){?>

      <div class="food-card">
            <div class="food-card-img">
              <img src="<?php echo $foods["food_img"]; ?>" alt="Food" />
            </div>
            <div class="food-card-price"><span>$</span><?php echo $foods["food_price"]; ?></div>
            <div class="food-card-info">
              <h5 class="food-card-name"><?php echo $foods["food_name"]; ?></h5>
              <p class="food-card-explanation">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni
                in pariatur atque aliquid voluptatum eaque quasi vero velit
                suscipit. Est.
              </p>
              <a href="./payment.php?foodId=<?php echo $foods["food_id"]; ?>" class="food-card-button">SHOP NOW</a>
            </div>
          </div>
<?php
      }
